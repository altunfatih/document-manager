...
public class AppController {
	...
	public String uploadFile(@RequestParam("document") MultipartFile multipartFile,
		...
		ra.addFlashAttribute("message", "The file has been uploadded successfully.");
		
		return "redirect:/";
	}
	
	@GetMapping("/download")
	public void donwloadFile(@Param("id") Long id, HttpServletResponse response) throws Exception {
